  ...
  return (
    <div style={containerStyle}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
        <h2 style={{ color: '#d72554' }}>Manage Products</h2>
        <Link
...
const editBtn = { background: '#e96e2d', color: '#fff', padding: '6px 12px', borderRadius: '4px', marginRight: '10px', textDecoration: 'none', display: 'inline-block' };
const deleteBtn = { background: '#d72554', color: '#fff', padding: '6px 12px', borderRadius: '4px', border: 'none', cursor: 'pointer' };
