...
const ProductDetail = () => {
  ...
  if (loading) return <div style={{ textAlign: 'center', margin: '100px', color: '#d72554' }}>Loading Product...</div>;
  ...
  return (
    <div className="product-detail-wrapper" style={{ maxWidth: '1200px', margin: '0 auto', padding: '20px' }}>
      ...
      <div style={{ color: '#6b6b6b', marginBottom: '20px', fontSize: '0.95rem' }}>
        <Link to="/" style={{ color: '#d72554' }}>Home</Link> / <Link to="/shop" style={{ color: '#d72554' }}>Shop</Link> / {product.category} / <span style={{ color: '#1a1a1a' }}>{product.name}</span>
      </div>
      ...
      <div className="product-detail">
        ...
        <div className="detail-info">
          ...
          <div style={{ marginBottom: '25px' }}>
            <h4 style={{ color: '#1a1a1a', marginBottom: '10px' }}>Product Description</h4>
            <p style={{ color: '#6b6b6b', lineHeight: '1.8' }}>{product.description}</p>
          </div>
